...
import com.valtxcorresponsal.autenticacion_service.security.repository.AgenteRepository;
import com.valtxcorresponsal.autenticacion_service.security.repository.UserRepository;
import com.valtxcorresponsal.autenticacion_service.security.service.jwt.JwtService;
...
public class AuthenticationServiceImpl implements AuthenticationService {
  ...
  public LoginResponseDto login(LoginRequestDto loginRequestDTO) {
    ...
    public Double obtenerSaldo(Long id) {
        return agenteRepository.findAgeSaldoByAgeId(id);

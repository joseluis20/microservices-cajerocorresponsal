package com.valtxcorresponsal.autenticacion_service.security.filters;
...
public class SecurityConfigurationFilter {
            ...
            request -> request
                .requestMatchers(
                    ...
                    "/api/docs/**",
                        ...
                        "/api/v1/auth/by-username",
                        "/api/v1/auth/agente/saldo/**")
                .permitAll()
  ...
  CorsConfigurationSource corsConfigurationSource() {
    ...
    config.addAllowedOrigin("http://192.168.18.7:8886");
    config.addAllowedOrigin("http://localhost:8886");
    config.addAllowedOrigin("http://192.168.18.7:8890");
    config.addAllowedOrigin("http://localhost:8890");
